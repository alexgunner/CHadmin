...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { bus_id: @delivery.bus_id, cost: @delivery.cost, destination_id: @delivery.destination_id } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { bus_id: @delivery.bus_id, cost: @delivery.cost, destination_id: @delivery.destination_id } }
