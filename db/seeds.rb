...
#category = Category.create(name: "Category 1", description: "This is a test category")
#subcategory = Subcategory.create(name: "Subcategory 1", description: "This is a test subcategory", category: category)
